...
<div class="main-container">
	...
	<?php
		...
		$sql="INSERT INTO booking (email, unitnumber, streetnumber, streetname, suburb, phonenumber, pickupdate, pickuptime, bookingdate, bookingtime, status) 
				VALUES('$_SESSION[email]','$_POST[unitnumber]','$_POST[streetnumber]','$_POST[streetname]','$_POST[suburb]','$_POST[number]','$_POST[pickupdate]','$_POST[pickuptime]','$date','$time','unsassigned')";
